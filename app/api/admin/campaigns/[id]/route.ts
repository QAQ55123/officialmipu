...
const ALLOWED_FIELDS = [
  "name", "opens_at", "closes_at", "cod_campaign_cap", "gift_cod_campaign_cap", "per_user_cod_cap", "per_user_gift_cod_cap", "checkout_gift_platform_id", "split_calc_fx_rate", "shipping_cost_per_kg", "gift_base_unit", "vendor_order_gift_cap",
